...
category:
  - 软件开发
  - Java
bookCover: https://m.media-amazon.com/images/I/7167aaVxs3L._SL1500_.jpg
cover:
tag:
  - Java
isOriginal: true
...
1. Joshua Bloch, _Effective Java, Third Edition_, Addison-Wesley Professional, 2018, ISBN `978-0-13-468599-1`。
2. 指定阅读材料：`Effective-Java-3rd-LaTex-Pattern.pdf`，`sjsdfg & jianshu` 社区译校，文件内标注日期 2018-02-27。
3. _Java Language Specification, Java SE 21 Edition_。
4. _Java Platform, Standard Edition 21 API Specification_。
