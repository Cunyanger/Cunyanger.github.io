...
# 《第一本 Docker 书（修订版）》从镜像构建到服务编配

> **文本依据**：《第一本 Docker 书（修订版）》，James Turnbull 著，李兆海、刘斌、巨震译，人民邮电出版社，ISBN 978-7-115-41933-0。“本书是 The Docker Book 一书 v1.9.1 版的中文版。” “本书特色”和内容提要则说明内容面向 **Docker 1.9 及以上版本**。
>
> **标注规则**：`原书代码`只做空格归一化和明显排版修复；无法在当前环境直接运行的旧命令仍予保留，但紧跟“2026 校订”。新增示例一律标作`现代示例`。
